...
```
docker pull ghcr.io/reticulalabs/reticulum-router:v1.10.7
docker run -v reticulum_data:/root/.config/reticulum ghcr.io/reticulalabs/reticulum-router:v1.10.7
```
